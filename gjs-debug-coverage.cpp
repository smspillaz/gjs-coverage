  ...
  if (!stats)
    {
      ...
      mark_executable_lines (stats, executable_lines, n_executable_lines);
                                 ...
                                 GParamSpec   *pspec)
{
  ...
  switch (prop_id)
    ...
    case PROP_INTERRUPT_REGISTER:
      ...
      break;
    case PROP_CONTEXT:
      coverage->priv->context = GJS_CONTEXT (g_value_dup_object (value));
      break;
...
gjs_debug_coverage_dispose (GObject *object)
{
  ...
  g_object_unref (coverage->priv->context);
}
